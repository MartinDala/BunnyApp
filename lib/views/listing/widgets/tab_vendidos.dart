...
class tab_vendidos extends StatefulWidget {
  const tab_vendidos({Key? key}) : super(key: key);

  @override
  _tab_vendidosState createState() => _tab_vendidosState();
}

class _tab_vendidosState extends State<tab_vendidos> {
  final ListingVendidosController _controller =
      ListingVendidosController(ListingRepositoryImp(DioServiceImp()));
