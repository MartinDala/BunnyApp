...
class tab_mortos extends StatefulWidget {
  const tab_mortos({Key? key}) : super(key: key);

  @override
  _tab_mortosState createState() => _tab_mortosState();
}

class _tab_mortosState extends State<tab_mortos> {
  final ListingMortosController _controller =
      ListingMortosController(ListingRepositoryImp(DioServiceImp()));
